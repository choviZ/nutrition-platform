...
-- 插入一些基础食物营养数据
INSERT INTO food_nutrition (food_name, food_category, calories_per_100g, protein_per_100g, carbohydrate_per_100g, fat_per_100g, fiber_per_100g) VALUES
('白米饭', '主食', 116.00, 2.60, 25.90, 0.30, 0.30),
...
-- 插入测试用户
INSERT INTO user (username, password, email, real_name, gender, age, height, weight, health_goal) VALUES
('testuser', '$2a$10$7JB720yubVSOfvVWdBYoOOxYH/tY.7VulJApVYpwUAdemgPL4bF46', 'test@example.com', '测试用户', 1, 25, 175.00, 70.00, 3);
